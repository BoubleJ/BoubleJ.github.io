---
date: "2025-12-14"
title: "고군분투 다이얼로그 제작 일지"
categories: ["React", "useOverlay", "Recoil", "shadcn/ui"]
...
<DetailReviewWriteBox Dialog={ReviewWriteDialog} onClose={onReviewWriteClose} />
```

```tsx
export default function DetailReviewWriteBox({ Dialog, onClose }: DetailReviewWriteBoxProps) {
  // 다이얼로그 내부에서 사용할 상태값들
