---
date: "2024-04-05"
title: "[키워드 프로젝트] 카테고리 컴포넌트 구현 1탄 (카테고리 컴포넌트 UI 제작)"
categories: ["Keyword"]
...
![카테고리컴포넌트UI기초](/image/카테고리컴포넌트UI기초.png)
...
![2,3차컴포넌트렌더링](/image/2,3차컴포넌트렌더링.gif)
