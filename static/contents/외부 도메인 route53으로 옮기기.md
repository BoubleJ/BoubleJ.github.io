...
![도메인관리](/image/도메인관리.png)

![네임서버설정](/image/네임서버설정.png)

아까 복사했던 `값/트래픽 라우팅 대상` 내용을 순차적으로 넣어주면 됩니다. 

![네임서버등록](/image/네임서버등록.png)
...
![버지니아북부](/image/버지니아북부.png)

![acm인증서요청](/image/acm인증서요청.png)
...
![클라우드프론트](/image/클라우드프론트.png)

![클라우드프론트배포편집](/image/클라우드프론트배포편집.png)
...
![클라우드프론트배포편집인증서떴다](/image/클라우드프론트배포편집인증서떴다.png)
...
![라우트53호스팅영역레코드생성](/image/라우트53호스팅영역레코드생성.png)
...
![라우트53레코드생성드디어된다](/image/라우트53레코드생성드디어된다.png)
