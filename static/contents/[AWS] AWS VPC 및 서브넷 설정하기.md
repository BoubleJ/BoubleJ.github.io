...
![서브넷라우팅테이블](/image/서브넷라우팅테이블.png)

  <BR>


![서브넷라우팅테이블2](/image/서브넷라우팅테이블2.png)
...
![오케이계획대로되고있어](/image/오케이계획대로되고있어.png)
...
vpc에 붙여준다.
![vpc붙이기](/image/vpc붙이기.png)

  <BR>


![vpc연결](/image/vpc연결.png)
...
![구글검색잘돼](/image/구글검색잘돼.png)

![검색잘된다고](/image/검색잘된다고.png)
