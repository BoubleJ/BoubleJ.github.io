...
![vercel프로젝트버튼](/image/vercel프로젝트버튼.png)

<br>

3. 배포하고자하는 git repository를 선택하고 import 해줍니다.

![플젝import](/image/플젝import.png)
...
![명령어수정](/image/명령어수정.png)

vercel 명령어로 수정한 뒤 다시 deploy 해줬습니다.

![vercel빌드성공](/image/vercel빌드성공.png)
