...
![vercel도메인창](/image/vercel도메인창.png)

add 클릭 후

![도메인추가](/image/도메인추가.png)

도메인을 입력해줍니다.

![도메인추가옵션](/image/도메인추가옵션.png)
...
![dns세팅완료](/image/dns세팅완료.png)

세팅해주면 vercel도 자동으로 업데이트 됩니다. 

![vercel도메인업데이트완료](/image/vercel도메인업데이트완료.png)
