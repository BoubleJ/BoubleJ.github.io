...
![가격조건분기처리안되는거디버깅](/image/가격조건분기처리안되는거디버깅.png)
...
![타입넘버로변환](/image/타입넘버로변환.png)


![넘버로변환후모달창렌더링성공](/image/넘버로변환후모달창렌더링성공.png)
