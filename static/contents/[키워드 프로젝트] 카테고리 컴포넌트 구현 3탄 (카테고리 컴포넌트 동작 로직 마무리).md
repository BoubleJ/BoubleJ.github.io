...
thumbnail: "/image/버튼div박스너무커서생긴문제.png"
---
...
![3차 카테고리 hover 후 1차 카테고리 이동시 3차 카테고리 사라지기](/image/3차카테고리hover후1차카테고리이동시3차카테고리사라지기.gif)
...
![버튼과컴포넌트안겹쳐서생긴문제](/image/버튼과컴포넌트안겹쳐서생긴문제.gif)
...
![부모컴포넌트이탈시모든컴포넌트사라짐](/image/부모컴포넌트이탈시모든컴포넌트사라짐.gif)
...
![부모컴포넌트가직사각형이라생기는에러](/image/부모컴포넌트가직사각형이라생기는에러.gif)

네,,, 아마 `ButtonBox` 와 `CategoryContainer` 컴포넌트의 width가 부모컴포넌트 길이만큼 차지해서 생기는 문제일 겁니다..

![버튼div박스너무커서생긴문제](/image/버튼div박스너무커서생긴문제.png)
