...
![즉시실행함수리액트돔](/image/즉시실행함수리액트돔.webp)

react-dom.development.js파일을 열어보니 IIFE로 실행되는 react-dom 코드를 발견할 수 있었습니다.

 

![ReactSharedInternals객체변경](/image/ReactSharedInternals객체변경.webp)
...
![ReactSharedInternals출처](/image/ReactSharedInternals출처.webp)
...
__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED는 
...
![renderWithHooks](/image/renderWithHooks.webp)
...
![ReactCurrentDispatcher](/image/ReactCurrentDispatcher.webp)
...
![HooksDispatcherOnMountInDEV](/image/HooksDispatcherOnMountInDEV.webp)\
...
> 여기서 중요한 점은 내부코드에서 사용한 것들은 모두 객체라는 점입니다.   자바스크립트에서 객체는 변수에 할당하면 주소값을 참조합니다.   즉, 객체는 얕은 복사를 하죠?
...
__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED를 가져와서
...
![mountRef까보기](/image/mountRef까보기.webp)
...
![mountWorkInProgressHook](/image/mountWorkInProgressHook.webp)
...
![currentlyRenderingFiber$1](/image/currentlyRenderingFiber$1.webp)
