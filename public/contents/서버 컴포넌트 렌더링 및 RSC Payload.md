---
date: "2024-10-13"
title: "서버 컴포넌트 렌더링 및 RSC Payload"
categories: ["Next.js"]
...
>참고로 바벨은 빌드타임에 동작합니다.   즉 빌드시 컴포넌트 -> 리액트 엘리먼트로 전환됩니다.
...
![자바스크립트파일위치](/image/자바스크립트파일위치.png)
